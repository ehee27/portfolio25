  ...
  return (
    ...
    >
      <Vortex
        ...
        particleCount={150}
        baseHue={120}
        className="flex flex-col justify-center items-center px-2 md:px-10 py-4 w-full h-[100%]"
      >
        <div className="w-screen h-[60%]">
          <div className="flex flex-col justify-center h-[100%]">
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 w-[100%] h-[50%]">
              <div>
                <Image
                  src={scott}
                  alt="scott lucas"
            ...
            <div className="hidden justify-center items-center gap-8 md:flex h-[30%]">
              {logos?.map((logo, i) => (
                <Image
                  key={i}
                  src={logo.src}
            ...
            <div className="flex justify-center items-center gap-4 mt-6 sm:block md:hidden">
              {logos?.map((logo, i) => (
                <Image
                  key={i}
                  src={logo.src}
